# interlaced-voices-choral-quantum-consciousness
"Interlaced Voices: Choral Singing as a Gateway to Embodied Quantum Consciousness. A speculative framework exploring choral (especially Gregorian) vibration-induced neuro-emotional coherence, microtubule quantum vibrations (Orch-OR), non-local unity states, and a guided meditative experiment. 

# Voci Intrecciate: Le Corali come Porta verso la Coscienza Quantistica Embodied
...
## File principali
- `Voci_Intrecciate__Le_Corali_come_Porta_verso_la_Coscienza_Quantistica_Embodied_v1.pdf` – Versione completa del paper

## Licenza
Questo lavoro è rilasciato sotto **Creative Commons Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)**.  
Puoi condividere e adattare il materiale liberamente per scopi non commerciali, purché attribuisci il credito agli autori originali.

Vedi il file `LICENSE.md` per i dettagli completi.

## Riferimenti principali
- Hameroff & Penrose (Orch-OR theory)
- Vickhoff et al. (2013) – Sincronizzazione cardiaca e respiratoria nel canto corale
- Müller et al. (2018, 2019) – Intersoggettiva sincronia EEG e network nel coro
- Pentikäinen et al. (2021) – Benefici cognitivi nel canto corale anziani
- Gao et al. (2019) – Correlati neurofisiologici del chanting religioso
- Harne & Hiwale (2018) – Analisi spettrale EEG su chanting OM

## Contatti
Per discussioni, collaborazioni o aggiornamenti: tetcollective@proton.me o https://tetcollective.org

✨ Voci intrecciate verso l’unità cosmica ✨
